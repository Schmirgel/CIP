// $ANTLR 3.4 Z:\\Compiler\\CIP\\Aufgabe 3\\Sebastian\\AST_Symbolraetsel.g 2015-12-17 12:43:09
package solver;
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final AST_SymbolraetselParser.prog_return prog() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: op52, id33, eq34, id55, op32, op23, eq41, id13, id33, id15, eq54, id11, id15, id55, id53, op12, id11, id31, op21, op22, eq14, id13, id53, id51, id35, id31, eq43, eq42, id35, id51
            // token labels: eq14, eq34, eq54, eq43, eq42, eq41
            // rule labels: id51, id53, id31, op52, id33, id55, id11, id13, id35, id15, retval, op32, op21, op22, op23, op12
            // token list labels: 
            // rule list labels: 
            // wildcard labels: 
            retval.tree = root_0;
